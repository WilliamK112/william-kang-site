...
(function setupLanguageToggle() {
  ...
  const translations = {
    ...
    zh: {
      ...
      heroSignal3: '正在寻找 2027 软件工程与 AI 实习机会',
      flipHint: '点击翻转',
      ...
      snapshotAuthValue: '已有授权',
      snapshotSponsorLabel: '未来签证支持',
      snapshotSponsorValue: '需要',
      originMapLabel: '身份背景',
      ...
      work1Period: '2026 年 5 月 - 至今 · 美国纽约 | 混合办公',
      work1Desc: '主导 AI 视频生成功能的后端开发，使用 FastAPI、PostgreSQL、Redis 和 Gemini 构建服务。实现并行关键帧与视频任务、结果缓存，并纳入 RBAC、可观测性及 CI/CD。直接与 CEO 和四个部门合作，梳理工程需求，交付通过 SSE 实时显示生成进度的看板。',
      workAkangTitle: 'AI 与软件工程实习生 · 阿康健康（AkangHealth）',
      workAkangPeriod: '2026 年 7 月 - 2026 年 8 月 · 中国 | 现场办公',
      workAkangDesc: '为医药市场情报工作设计多智能体研究流程，加入证据分级、人工审核节点与自动验证。构建可搜索界面及 JSON/SQLite 结构化导出，保留来源 ID、检索日期与引文检查，让研究结果可追溯。',
      ...
      project2Tech: 'Next.js、TypeScript、React、Node.js、PostgreSQL、Drizzle ORM、Gemini API、pdf-lib。',
      project2Impact: '将租约和房屋检查信息转换为可审计、带时间戳的证据 PDF，并获得威斯康星大学麦迪逊分校创业赛道三等奖。',
      ...
      project5Impact: '实现稳定的双人追踪、姿态叠加与可用于演示的比赛分析可视化。',
      ...
      awardsEyebrow: '荣誉认可',
      awardsTitle: '奖项与荣誉',
      awardsNote: '精选工程、数据、机器人与数学竞赛荣誉。每张卡片均提供公开证明或记录链接。',
      awardsProfile: 'Devpost 成就',
      award1Placement: '第二名',
      award1Title: 'Cursor 黑客松 · TableUs',
      award1Desc: '构建 AI 团体餐饮产品，综合多人偏好、场景与附近餐厅完成智能匹配。',
      award2Placement: '创业赛道三等奖',
      award2Title: 'Badger Build Fest · ClearMove',
      award2Desc: '构建 AI 租赁证据流程，将租约、检查表和照片整理为结构化报告。',
      award3Placement: '第三名',
      award3Title: '华盛顿大学黑客松',
      award3Desc: '在高强度大学黑客松中，凭团队技术方案获得认可。',
      award4Placement: '第二名',
      award4Title: '乔治·华盛顿大学数据科学协会 Datathon',
      award4Desc: '在数据竞赛中运用 Python 分析与数据叙事完成解决方案。',
      award5Placement: '机器人技能第二名 · 资格赛第三名',
      award5Title: 'VEX VRC 高中组',
      award5Desc: '结合 C++ 编程、机器人迭代与竞赛策略获得机器人赛事荣誉。',
      award6Year: '2025',
