...
(function setupLanguageToggle() {
  ...
  const translations = {
    en: {
      ...
      heroLead: 'UW-Madison CS + Data Science student building open-source AI tools, agent workflows, backend systems, and developer tooling. I publish work as William Kang and Ching-Wei Kang across GitHub, LinkedIn, Devpost, and open-source contributions.',
      heroSignal1: 'Now Shipping: Open-Source AI Tools',
      heroSignal2: '48 Merged GitHub PRs',
      heroSignal3: 'Seeking Software Engineering Internships',
      ctaResume: 'Resume',
      ctaEmail: 'Copy Email',
      ...
      snapshotFocusValue: 'AI Agents · Backend Systems · Data Pipelines · OSS Tooling',
      snapshotTechLabel: 'Tech',
      snapshotTechValue: 'TypeScript · Python · Node.js · GitHub CI',
      snapshotAuthLabel: 'Work Auth (US)',
      snapshotAuthValue: 'Yes',
      snapshotSponsorLabel: 'Sponsorship',
      snapshotSponsorValue: 'Yes (future)',
      educationTitle: 'Education',
      educationDesc: 'Studied <span class="keyword-highlight">Data Science</span> at <span class="keyword-highlight">George Washington University</span> (2023–2024), then transferred to <span class="keyword-highlight">the University of Wisconsin–Madison</span> (2025–2027), where I am pursuing a <span class="keyword-highlight">BS double major in Computer Science and Data Science</span>. <span class="keyword-highlight">GPA: 3.75 / 4.0</span>. <span class="keyword-highlight">Expected graduation: May 2027</span>.',
      statsProjects: 'Featured Projects',
      statsPublicRepos: 'Public Repos',
      statsOriginalRepos: 'Original Repos',
      statsMergedPrs: 'Merged PRs',
      ...
      projectsNote: 'Selected from current public GitHub work: 23 original repos spanning AI tooling, agent workflows, computer vision, reinforcement learning, and deployable product experiments.',
    ...
    zh: {
      ...
      heroRole: '软件工程师',
      heroLead: '我就读于威斯康星大学麦迪逊分校，主修计算机科学与数据科学，正在构建开源 AI 工具、agent 工作流、后端系统与开发者工具。我擅长把原型快速推进到可展示、可使用的工程化成果。',
      heroSignal1: '当前重点：开源 AI 工具',
      heroSignal2: 'GitHub 已合并 PR：48 个',
      heroSignal3: '正在寻找软件工程实习',
      ctaResume: '查看简历',
      ctaEmail: '复制邮箱',
      ctaGithub: '查看 GitHub',
      ctaLinkedIn: '领英主页',
      ...
      snapshotFocusValue: 'AI Agent · 后端系统 · 数据流水线 · 开源工具',
      ...
      educationTitle: '教育背景',
      educationDesc: '2023–2024 年就读于<span class="keyword-highlight">乔治·华盛顿大学</span>，学习<span class="keyword-highlight">数据科学</span>；2025–2027 年转学至<span class="keyword-highlight">威斯康星大学麦迪逊分校</span>，攻读<span class="keyword-highlight">计算机科学与数据科学双专业</span>。<span class="keyword-highlight">GPA：3.75 / 4.0</span>，<span class="keyword-highlight">预计 2027 年 5 月毕业</span>。',
      statsProjects: '重点项目',
      statsPublicRepos: '公开仓库',
      statsOriginalRepos: '原创仓库',
      statsMergedPrs: '已合并 PR',
      ...
      projectsTitle: '项目',
      projectsMore: '查看更多项目',
      projectsNote: '精选自当前公开 GitHub 工作：23 个原创仓库，覆盖 AI 工具、agent 工作流、计算机视觉、强化学习与可部署产品实验。',
